...
public class SnackarHelperByColor_RegionCheck {
    private static Snackbar snackbar_obj;

    public static void show(View root, String message, String actionName, int colorOdescrText, int colorOfBtnText, View.OnClickListener onClickListener, View.OnClickListener onClickListenerRegion) {
...
//        View snackView = ((LayoutInflater) root.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.snack_bar_custom_region_check, null);
...
//        ((TextView) snackView.findViewById(R.id.snackbar_clicked_show_region)).setTextColor(colorOfBtnText);
//
...
//            snackView.findViewById(R.id.snackbar_clicked_show_region).setOnClickListener(onClickListenerRegion);
//
//        } else {
